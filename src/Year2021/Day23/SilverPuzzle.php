...
//        ];
        ...
        $this->variations[$startKey] = $start;

        sort($goal);
        $goalKey = json_encode($goal);
        $this->variations[$goalKey] = $goal;
    ...
    private function buildMaze()
    {
        ...
        $rooms = [
            'a' => [MazeCell::A_ROOM, MazeCell::A_ROOM],
            'b' => [MazeCell::B_ROOM, MazeCell::B_ROOM],
            'c' => [MazeCell::C_ROOM, MazeCell::C_ROOM],
            'd' => [MazeCell::D_ROOM, MazeCell::D_ROOM],
        ];
        $id = count($hall) + 1;
