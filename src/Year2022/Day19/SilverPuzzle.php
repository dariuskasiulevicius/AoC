...
//(You guessed 1344.)That's not the right answer; your answer is too low. If you're stuck, make sure you're using the full input data; there are also some general tips on the about page, or you can ask for hints on the subreddit. Please wait one minute before trying again.
//(You guessed 1640.)That's not the right answer; your answer is too low. If you're stuck, make sure you're using the full input data; there are also some general tips on the about page, or you can ask for hints on the subreddit. Please wait one minute before trying again.
class SilverPuzzle implements PuzzleResolver
{
    ...
    public function resolve(DataInput $inputData)
    {
        ...
        foreach ($bluePrints as $bluePrint) {
            ...
            $result += $case->getGeodes() * $case->getNumber();
//            break;
        }
